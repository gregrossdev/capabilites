...
Vendored from the official Svelte plugin ([sveltejs/ai-tools](https://github.com/sveltejs/ai-tools), MIT, plugin v1.0.9).

- `svelte-code-writer` — CLI tools for Svelte 5 documentation lookup and code analysis
- `svelte-core-bestpractices` — reactivity, events, styling and library integration guidance, with references
